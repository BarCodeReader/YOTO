...
default_cfgs = {
    ...
    "resnetv2_50d_gn": _cfg(interpolation="bicubic", first_conv="stem.conv1"),
    "resnetv2_50d_evob": _cfg(interpolation="bicubic", first_conv="stem.conv1"),
    "resnetv2_50d_evos": _cfg(interpolation="bicubic", first_conv="stem.conv1"),
}
